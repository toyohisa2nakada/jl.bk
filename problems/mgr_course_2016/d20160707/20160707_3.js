new function(){
	...
	var self_n = problems.problems.push([
		function(){
			...
			window.exec({module:"input",command:"addValue",params:{name:"name",initValue:["\"新潟\"","\"大阪\""]}});
			plib.setExpectedOutputs(													 ["出力 新潟はお米が有名です。","出力 大阪はたこ焼きが有名です。"]);
			...
			window.exec({module:"code",command:"setInitialText",params:{
				setEditable:[[{line:10,ch:6},{line:10,ch:10}]],
				text:"\
\/\/ 入力の下に書かれている出力どおりになるプログラムを作成してください。\n\
\/\/ \n\
\/\/ print(name+\"お米\"); は、nameの文字に「お米」が後ろに追加されて出力されます。\n\
 \n\
var msg = \"\";\n\
if(name == \"新潟\"){\n\
	msg = \"お米\";\n\
 ...
 "}});
		...
		function(){
			...
			w.$(".CodeMirror").instruct({
				string:"この指示に従ったプログラムを作成してください。<br/><br>"+
					"灰色の部分は、変更することはできません。",
				closeButton:true,
