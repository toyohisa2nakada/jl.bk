new function(){
	...
	var self_n = problems.problems.push([
		function(){
			...
			window.exec({module:"input",command:"addValue",params:{name:"a",initValue:["[1,2,3]","[5,5,5]","[-1,-2,-3]"]}});
			window.exec({module:"input",command:"addValue",params:{name:"b",initValue:["[9,2,7]","[1,2,3]","[ 0, 2,-3]"]}});
			messages = 																  ["出力<br>0<br>1<br>0","出力<br>0<br>0<br>0","出力<br>0<br>0<br>1"];
