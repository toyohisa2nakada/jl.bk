new function(){
	...
	problems.problems.push([
		function(){
			...
			window.exec({module:"input",command:"addValue",params:{name:"a",initValue:[5,2,1,]}});
			window.exec({module:"input",command:"addValue",params:{name:"b",initValue:[2,6,4,]}});
			window.exec({module:"input",command:"addValue",params:{name:"c",initValue:[1,3,7,]}});
/*
...
\/\/ 最大値の入っている変数名を出力するプログラムを作成してください。\n\
