new function(){
	...
	var errorMessages = ["違います。","違います。printが実行される回数を考えてみてください。","違います。最初のsum += 2によってsumの値は2になります。"];
	var errorNo = 0;
...
\/\/ \n\
\/\/ sum += 2は、sumの中の値を2つ増やします。\n\
\/\/ 例えばsumの値が3だった場合、sum += 2を実行した後は、5になります。\n\
\/\/ \n\
var sum = 0;\n\
 \n\
sum += 2;\n\
