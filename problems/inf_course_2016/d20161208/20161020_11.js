new function(){
	...
	var self_n = problems.problems.push([
		function(){
			...
			plib.setExpectedOutputs(["出力<br>3<br>2<br>1","出力<br>5<br>2<br>-1","出力<br>9<br>6<br>2","出力<br>3<br>2<br>1","出力<br>-1<br>-2<br>-5","出力<br>4<br>3<br>0"]);
			window.exec({module:"input",command:"setInitial",params:{
				pnumber:scriptName,
				message:plib.getExpectedOutputs(),
				value:[
					{name:"a",initValue:["1","-1","6","2","-1","4"]},
					{name:"b",initValue:["2","5" ,"2","3","-5","3"]},
					{name:"c",initValue:["3","2" ,"9","1","-2","0"]},
				],
			}});
			...
			window.exec({module:"code",command:"setInitialText",params:{
				setEditable:[[{line:1,ch:0},{line:3,ch:0}]],
				text:"\
\/\/ 変数a, b, cの中身の数字を、最大、中間、最小値の順番で表示してください。\n\
\n\
\n\
\
"}});
