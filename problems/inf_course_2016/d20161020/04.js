new function(){
	...
	var self_n = problems.problems.push([
		function(){
			...
			plib.setExpectedOutputs(["出力 1","出力 2","出力 3"]);
			window.exec({module:"input",command:"setInitial",params:{
				pnumber:scriptName,
				message:plib.getExpectedOutputs(),
				value:[
					{name:"a",initValue:["4","0","8"]},
					{name:"b",initValue:["4","1","6"]},
				],
			}});
			...
			window.exec({module:"code",command:"setInitialText",params:{
				setEditable:[[{line:3,ch:3},{line:3,ch:9}],[{line:5,ch:9},{line:5,ch:15}]],
				text:"\
\/\/ aとbの値が同じ場合は1、aの方が小さい場合は2、\n\
\/\/ aが大きい場合は3を出力してください。\n\
 \n\
if(      ){\n\
	print(\"1\");\n\
