new function(){
	...
	var errorMessages = ["違います。","違いますよ","違うんですってば","もう一回お願いします( ˘ω˘ )"];
	var errorNo = 0;
	...
	var self_n = problems.problems.push([
		function(){
			...
			plib.setExpectedOutputs(["出力<br>2<br>2<br>4<br>4<br>6<br>6<br>8<br>8"]);
			window.exec({module:"input",command:"setInitial",params:{
				pnumber:scriptName,
				value:[
					{name:"a",initValue:"[2,4,6,8]"},
				],
			}});
