new function(){
	...
	var self_n = problems.problems.push([
		function(){
			...
			plib.setExpectedOutputs(["出力<br>コイキング<br>コダック","出力<br>リザードン<br>ヒノアラシ","出力<br>ピカチュ―","出力<br>フシギダネ<br>ナッシー","出力<br>イーブイ<br>ニャース"]);
			window.exec({module:"input",command:"setInitial",params:{
				pnumber:scriptName,
				message:plib.getExpectedOutputs(),
				value:[
					{name:"c",initValue:["\"みず\"","\"ほのお\"","\"でんき\"","\"くさ\"","\"ノーマル\""]},
				],
			}});
			...
			window.exec({module:"code",command:"setInitialText",params:{
				setEditable:[[{line:11,ch:4},{line:11,ch:18}],[{line:13,ch:8},{line:13,ch:16}]],
				text:"\
\/\/ それぞれの入力に対して正しく出力するプログラムを完成させてください。\n\
\/\/ プログラムを追加する箇所は、「2か所」です。\n\
\/\/ \n\
var pokemon = [\"コイキング\",\"ピカチュ―\",\"リザードン\",\n\
				\"フシギダネ\",\"イーブイ\",\"コダック\",\n\
				\"ナッシー\",\"ヒノアラシ\",\"ニャース\"];\n\
var type = [\"みず\",\"でんき\",\"ほのお\",\n\
				\"くさ\",\"ノーマル\",\"みず\",\n\
